...
public class FileManagerProvider extends ContentProvider {
	...
	static final String FILE_PROVIDER_PREFIX = "content://com.vikingbrain.dmt.oi.filemanager";
	
	public static final String AUTHORITY = "com.vikingbrain.dmt.oi.filemanager";
	...
	public Cursor query(Uri uri, String[] projection, String s, 
		...
		if (uri.toString().startsWith(FILE_PROVIDER_PREFIX)) {
			...
			String displayName = "";
			if (fromIndex > 0){
				displayName = data.substring(fromIndex);
			} else {
				displayName = data;
			}
