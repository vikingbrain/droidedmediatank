...
import com.vikingbrain.dmt.view.asynctaks.TaskFtpGetFileBundleContextFile;
import com.vikingbrain.dmt.view.asynctaks.TaskFtpGetFileBundleDirectory;
import com.vikingbrain.dmt.view.asynctaks.TaskFtpGetFileByIntentData;
import com.vikingbrain.dmt.view.asynctaks.TaskFtpGetParentFile;
import com.vikingbrain.dmt.view.asynctaks.TaskFtpPickFileOrDirectory;
...
public class FileManagerActivity_OLD extends SherlockListActivity implements
			...
			TaskFtpGetFileByIntentData.OnResultTaskFtpGetFileByIntentData,
	...
	private static final String TAG = FileManagerActivity_OLD.class.getSimpleName();
	...
	public void onCreate(Bundle _icicle) {
		...
		currentHandler = new Handler() {
			public void handleMessage(Message msg) {
				FileManagerActivity_OLD.this.handleMessage(msg);
			}
		};
		...
		new TaskFtpGetFileByIntentData(this, ftpService).execute(intent);			
	}

	@Override
	public void onResultTaskFtpGetFileByIntentData(DMTFile file) {
		...
		if (icicle != null) {
			...
			new TaskFtpGetFileBundleDirectory(this, ftpService).execute(bundleCurrentDirectory);			
		}
	...
	@Override
	public void onResultTaskFtpGetFileBundleDirectory(DMTFile _browseto) {

			browseto = _browseto;
			
			String bundleContextFile = icicle.getString(BUNDLE_CONTEXT_FILE);
			
			new TaskFtpGetFileBundleContextFile(this, ftpService).execute(bundleContextFile);	
	}

	@Override
	public void onResultTaskFtpGetFileBundleContextFile(DMTFile _mContextFile) {
	...
	private void pickFileOrDirectory() {
		...
		if (mState == STATE_PICK_FILE) {
			...
			new TaskFtpPickFileOrDirectory(this, ftpService).execute(currentDirectory, filename);
	...
	@Override
	public void onResultTaskFtpPickFileOrDirectory(DMTFile file) {
		executeCommonIntent(file);
	}
	...
	@Override
	public void onResultTaskFtpGetParentFile(DMTFile parentFile) {
		browseTo(parentFile);
	}
	...
	private class RecursiveDeleteTask extends AsyncTask<Object, Void, Integer> {
		...
		private FileManagerActivity_OLD activity = FileManagerActivity_OLD.this;
				...
				if (toggleButton.isChecked()) {
					...
					new AsyncTask<Object, Void, Boolean>(){
						...
						protected void onPostExecute(Boolean _correcto){ //result
							...
							Toast.makeText(FileManagerActivity_OLD.this, R.string.exclude_on, Toast.LENGTH_SHORT).show();
					...
					new AsyncTask<Object, Void, Boolean>(){
						...
						protected void onPostExecute(Boolean _correcto){ //result
							...
							Toast.makeText(FileManagerActivity_OLD.this, R.string.exclude_off, Toast.LENGTH_SHORT).show();
							//refresh the file browser
							refreshList();
						}							
