...
/**
 * Playlist strategy for myIHome.
 * 
 * @author Rafael Iñigo
 */
public class PlaylistStrategyMyiHome implements PlaylistStrategy {
	 ...
	 */
	public PlaylistStrategyMyiHome(SettingsService settingsService) {
		super();
	...
	public File getPlaylistTarget(File fileDir){
		File playlistFile = new File(fileDir, Constants.PLAYLIST_MYIHOME_FILE_NAME);
		return playlistFile;
	}

	/** {@inheritDoc} */
	public String calculateUrlForFile(DMTFile file){
		Uri streamUri = UtilProfile.getUriMyiHomeStream(file, settingsService.getActiveProfile());
