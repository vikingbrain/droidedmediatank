...
package com.vikingbrain.dmt.oi.filemanager.util;
...
public class MimeTypeParser {
	...
	private static final String TAG = MimeTypeParser.class.getSimpleName();
